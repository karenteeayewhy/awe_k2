...
<table width="100%" height="650" border="0" cellpadding="0" cellspacing="0">
  ...
  <div id="map" style="width: 100%; height: 650px;">  </div></td><td width="12" valign="top"><br>
    </div>
...
//Locations to be mapped and inputting the codes. [4] is the ID , [5] is the type of marker
    var locations = [
      ['Astla Technology', -33.890542, 151.274856, 4, '901', 'biz'],
      ['Green Syndrome Inc', -33.923036, 151.259052, '971', 'biz'],
      ['Balance Central', -34.028249, 151.157507, 3, '901', 'biz'],
      ['Green Syndrome Inc', -33.80010128657071, 151.28747820854187, 2, '971', 'biz'],
