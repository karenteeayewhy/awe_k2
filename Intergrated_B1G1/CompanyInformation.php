	...
	echo "<b>The Company information for this item is currently being updated. Sorry for any inconvenience caused.</b>";
		...
		while($row = mysql_fetch_array($result))
		  ...
		  if($row['logoURL']==null){
			...
			echo "<img class=\"border\" src=\"https://www.b1g1.com/buy1give1/sites/default/files/company/" . $row['logoURL'] . "\"alt='Four Oh Four' onError='this.onerror=null;this.src=\"./images/emptyIcon.jpg\";'  \">";
		  }
...
<script>
	function imgError(image){
		image.onerror ="";
		image.src = "/images/emptyIcon.jpg"
		return true;
}
</script>
	</body>
