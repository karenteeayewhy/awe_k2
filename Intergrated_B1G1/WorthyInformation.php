	...
	echo "<b>The Worthy Cause information for this item is currently being updated. Sorry for any inconvenience caused.</b>";	
		...
		while($row = mysql_fetch_array($result))
		  ...
		  if($row['logo_url']==null) {	
			...
			echo "<img class=\"border\" src=\"https://www.b1g1.com/buy1give1/sites/default/files/WC/" . $row['logo_url'] . "\"alt='Four Oh Four' onError='this.onerror=null;this.src=\"./images/emptyIcon.jpg\";'  \">";
		}
