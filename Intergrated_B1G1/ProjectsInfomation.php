		...
		while($row = mysql_fetch_array($result))
		  ...
		  if($row['pic1URL']==null){
			echo "&nbsp;";
				...
				echo "<img class=\"border\" src=\"https://www.b1g1.com/buy1give1/sites/default/files/project/" . $row['pic1URL'] . "\"alt='Four Oh Four' onError='this.onerror=null;this.src=\"./images/emptyIcon.jpg\";'  \">";
		  }
